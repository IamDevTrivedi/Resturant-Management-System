...
// ✅ Format ISO or simple time to readable 12-hour format
const formatTime = (timeStr: string): string => {
  if (!timeStr) return "N/A";

  try {
    const date = new Date(timeStr);
    if (isNaN(date.getTime())) return timeStr; // fallback if invalid ISO
    ...
    <main className="min-h-screen bg-background">
      <div className="max-w-5xl mx-auto px-4 py-6 sm:py-8 md:py-12">
        ...
        <div className="mb-8 md:mb-12">
          <div className="rounded-lg overflow-hidden bg-muted h-64 md:h-80 mb-6 relative">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              <span className="text-sm text-muted-foreground">
                ...
                {restaurant.ratingsCount === 1 ? "review" : "reviews"})
              </span>
            </div>
          </div>
        </div>
