      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mt-6 sm:mt-8 p-4 sm:p-5 border border-border shadow-sm">
          <p className="text-sm text-muted-foreground">
            <span className="font-semibold text-foreground">Pro Tip:</span> All fields marked with an asterisk{" "}
            <span className="text-destructive">*</span> are required. Your restaurant information will be saved securely
