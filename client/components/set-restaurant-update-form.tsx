...
import { Building2, MapPin, Clock, ImageIcon, CheckCircle, Loader } from 'lucide-react';
import {
    Form,
    FormControl,
    FormField,
...
export function MultiStepRestaurantFormEdit() {
        ...
        const fetchRestaurantData = async () => {
            try {
                ...
                if (data && data.success) {
                    ...
                    console.log('data1', restaurantData);
                    ...
                    <Card className="w-full max-w-md p-6 sm:p-8 space-y-4 sm:space-y-6 animate-in fade-in zoom-in">
                        ...
                        <div className="text-center space-y-2">
                            ...
                            <p className="text-base sm:text-lg text-muted-foreground">
                                Your restaurant details have been successfully updated. Redirecting
                                to dashboard...
                            </p>
                        </div>
