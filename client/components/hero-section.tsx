            ...
            <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:flex-row lg:items-center lg:gap-12">
              <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left">
                ...
                <p className="mt-8 max-w-2xl text-pretty text-lg">
                  Discover and book tables at the finest restaurants. From casual dining to fine cuisine, find your next
                  unforgettable meal in seconds.
                </p>
                ...
                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                  ...
                  <Button key={2} asChild size="lg" variant="outline" className="px-5 text-base">
