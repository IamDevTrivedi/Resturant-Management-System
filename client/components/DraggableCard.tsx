...
export function DraggableCard() {
  ...
  const items = [
    ...
    },
    {
      title: 'Biryani',
      image: '/Biryani.avif',
      className: 'absolute top-[50%] left-[40%] -translate-x-[85%] -translate-y-[40%] rotate-[-7deg]',
    },
    {
      title: 'Masala Dosa',
      image: '/MasalaDosa.avif',
      className: 'absolute top-[45%] left-[50%] -translate-x-[50%] -translate-y-[80%] rotate-[8deg]',
    },
    {
      title: 'Paneer Tikka',
      image: '/PaneerTikka.avif',
      className: 'absolute top-[55%] left-[60%] -translate-x-[30%] -translate-y-[50%] rotate-[10deg]',
    },
    {
      title: 'Samosa',
      image: '/Samosa.avif',
      className: 'absolute top-[50%] left-[70%] -translate-x-[30%] -translate-y-[60%] rotate-[2deg]',
    },
    {
      title: 'Tandoori Chicken',
      image: '/TandooriChicken.avif',
      className: 'absolute top-[55%] left-[45%] -translate-x-[70%] -translate-y-[20%] rotate-[-7deg]',
    },
    {
      title: 'Chole Bhature',
      image: '/CholeBhature.avif',
      className: 'absolute top-[60%] left-[50%] -translate-x-[50%] -translate-y-[40%] rotate-[4deg]',
    },
  ];
