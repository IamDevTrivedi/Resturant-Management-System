        ...
        {foodImages.map((food, index) => (
          <div
            ...
            className={`absolute transition-all duration-1000 ease-out ${
              imageIndex === index ? "opacity-100 scale-100 z-10" : "opacity-0 scale-75 z-0"
            }`}
            style={{
              animation:
                imageIndex === index ? "slideInRotate 1s ease-out forwards, float 4s ease-in-out infinite 1s" : "none",
            }}
          >
